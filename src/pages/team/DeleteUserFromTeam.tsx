...
const DeleteUserFromTeam: React.FC = () => {
  ...
  const handleDeleteUser = async () => {
    try {
      ...
      const response = await axios.get('http://51.21.48.160:8080/api/users/profile', config);
      ...
      const deleteResponse = await axios.delete(`http://51.21.48.160:8080/api/teams/${teamId}/deleteUser?nickname=${selectedUser}`, config);
